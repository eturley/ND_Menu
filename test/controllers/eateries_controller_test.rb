...
class EateriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create eatery" do
    assert_difference('Eatery.count') do
      post eateries_url, params: { eatery: { description: @eatery.description, location: @eatery.location, name: @eatery.name } }
    end
  ...
  test "should update eatery" do
    patch eatery_url(@eatery), params: { eatery: { description: @eatery.description, location: @eatery.location, name: @eatery.name } }
