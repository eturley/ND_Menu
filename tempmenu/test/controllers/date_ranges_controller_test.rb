...
class DateRangesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create date_range" do
    assert_difference('DateRange.count') do
      post date_ranges_url, params: { date_range: { end: @date_range.end, start: @date_range.start } }
    end
  ...
  test "should update date_range" do
    patch date_range_url(@date_range), params: { date_range: { end: @date_range.end, start: @date_range.start } }
